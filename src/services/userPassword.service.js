export class userPasswordService {
  ...
  static getUserPassword = async(params) => {
        return this.dao.get(params, this.model)
    }

   static saveUserPassword = async(data) => {
        return this.dao.post(data, this.model)
    }

    static updateUserPassword = async(id,updates)=>{
    ...
    static deleteUserPassword = async(condicion) =>{
